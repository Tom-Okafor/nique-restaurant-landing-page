...
export default function MenuTitle() {
  return (
    <section className="w-[50vw] h-screen bg-default-bg py-[6.4vh] flex flex-col items-center justify-between bg-[url('menu-main.png')] bg-cover bg-no-repeat">
      <Logo />
      <div className="text-center my-auto">
        ...
        <h1 className="capitalize text-heading-medium text-default font-Chillax-medium overflow-hidden flex items-center gap-4 justify-center">
          <AnimatedText text={"our menus".split(" ")} delay={500} />
        </h1>
      </div>
      <Menu />
    </section>
